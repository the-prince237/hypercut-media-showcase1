...
const ContactUs = () => {
  return (
    <Box className='relative flex flex-col items-center justify-center gap-[50px] py-[200px]'>
      ...
      <Typography className='relative max-w-[1245px] text-center text-[45px] font-[400] text-white tablet:text-[54px] minLaptop:text-[63px] minLaptop:leading-[110px] laptopView:text-[96px]'>
